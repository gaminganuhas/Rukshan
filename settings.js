...
SESSION_ID: process.env.SESSION_ID === undefined ? '𝙰𝚂𝙸𝚃𝙷𝙰-𝙼𝙳=36RUhK4K#kRGc0GdfJH6skX539kdr_mqp-Rth93JdsuHdBG7OisA' : process.env.SESSION_ID,
PREFIX: process.env.PREFIX || '.' ,
PORT: process.env.PORT === undefined ? "8000" : process.env.PORT,
SUDO: process.env.SUDO === undefined ? '94702318919' : process.env.SUDO,
SESSION_NAME: process.env.PORT === undefined ? "rukshan" : process.env.SESSION_NAME,
...
DELETEMSGSENDTO : process.env.DELETEMSGSENDTO === undefined ? '94702318919' : process.env.DELETEMSGSENDTO,
